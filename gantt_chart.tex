...
\begin{tikzpicture}
    ...
    \ganttbar{Task 2.5: Establishing a Greek Ecosystem of Partners in Space-based Geosciences}{6}{12} \\
    % WP3
    ...
    \ganttbar{Task 4.5: Dissemination Activities and Support for the Greek Ecosystem}{6}{36} \\
    % bar between Tasks
